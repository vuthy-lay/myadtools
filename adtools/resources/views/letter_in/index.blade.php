...
<div class="row col-md-2 pull-right">
    <a type="button" class="btn btn-block btn-primary btn-flat" href='/letterin_create'>ការបង្កើតថ្មី</a>
</div>
<div class="row">
  <div class="col-xs-12">
    <div class="box">
      <div class="box-header">
        <h3 class="box-title">លិខិតចូល</h3>

        <div class="box-tools" style="width: 300px;">
          {!! Form::open(['url'=>'letterin', 'method'=>'get', 'class'=>'form-horizontal']) !!}
      ...
      <div class="box-body table-responsive no-padding">
        <table class="table table-hover">
          ...
          <tr>
            ...
            <td>
              <div class="pull-left">
                <a type="button" class="btn btn-info" href="/letterin_show/{{ $item->letter_code }}"><i class="fa fa-newspaper-o"></i> ព័ត៌មានលំអិត</a>
  ...
  <div class="modal modal-danger fade" id="modal-danger">
    <div class="modal-dialog">
      <div class="modal-content">
        ...
        <form method="post" action="{{config('app.url_ip')}}/letterin_remove">
