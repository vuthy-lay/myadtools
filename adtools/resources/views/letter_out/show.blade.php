...
<div class="box box-info">
  ...
  <!-- /.box-header -->
  <!-- form start -->
  {!! Form::model($letterinfo[0], ['url'=>['letterout_show', $letterinfo[0]->seq], 'method'=>'get', 'class'=>'form-horizontal']) !!}
    ...
    <div class="box-body">
      ...
      <div class="form-group">
        {!! Form::label('letter_distination', 'គោលដៅ', ['class'=>'col-sm-2 control-label']); !!}
        <div class="col-sm-10">
          {!! Form::text('letter_distination', null, ['class'=>'form-control', 'placeholder'=>'Letter Distination', 'disabled' => 'disabled']); !!}
        </div>
      </div>
