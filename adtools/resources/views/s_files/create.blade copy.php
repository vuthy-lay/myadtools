  ...
  {!! Form::open(['url'=>'staffcreate', 'class'=>'form-horizontal', 'files' => true, 'enctype' =>'multipart/form-data']) !!}
    ...
    {!! Form::hidden('staff_code', 's', ['class'=>'form-control']); !!}
      ...
      <div class="box box-success box-header with-border">
        <h3 class="box-title">ព័ត៌មានផ្ទាល់ខ្លួន</h3>
        <div class="box-body">
          ...
          <div class="form-group col-ms-12 col-md-12 col-xs-12">
            ...
            <div class="col-md-4 col-ms-4">
              {!! Form::label('per_email', 'អ៊ីម៉ែល', ['class'=>'control-label']); !!}
              {!! Form::text('per_email', null, ['class'=>'form-control', 'placeholder'=>'អ៊ីម៉ែល']); !!}
              {!! $errors->has('per_email')?$errors->first('per_email'):'' !!}
            </div>
            <div class="col-md-4 col-ms-4">
          ...
          <div class="form-group col-ms-12 col-md-12 col-xs-12">
            ...
            <div class="col-md-4 col-ms-4">
              {!! Form::label('per_father_job', 'មុខរបរឪពុក', ['class'=>'control-label']); !!}
              {!! Form::text('per_father_job', null, ['class'=>'form-control', 'placeholder'=>'មុខរបរឪពុក']); !!}
              {!! $errors->has('per_father_job')?$errors->first('per_father_job'):'' !!}
            </div>
          </div>
          <div class="form-group col-ms-12 col-md-12 col-xs-12">
            <div class="col-md-4 col-ms-4">
            ...
            <div class="col-md-4 col-ms-4">
              {!! Form::label('per_mother_job', 'មុខរបរម្ដាយ', ['class'=>'control-label']); !!}
              {!! Form::text('per_mother_job', null, ['class'=>'form-control', 'placeholder'=>'មុខរបរម្ដាយ']); !!}
              {!! $errors->has('per_mother_job')?$errors->first('per_mother_job'):'' !!}
            </div>
          </div>
          <div class="form-group col-ms-12 col-md-12 col-xs-12">
            <div class="col-md-4 col-ms-4">
              {!! Form::label('per_current_salary_level', 'កាំប្រាក់បៀវត្ស', ['class'=>'control-label']); !!}
              {!! Form::text('per_current_salary_level', null, ['class'=>'form-control', 'placeholder'=>'កាំប្រាក់បៀវត្ស']); !!}
              {!! $errors->has('per_current_salary_level')?$errors->first('per_current_salary_level'):'' !!}
            </div>
            <div class="col-md-4 col-ms-4">
      ...
      <!-- End_PersonInfo -->
        ...
        <!-- PersonChild & Family -->
      <div class="box box-success box-header with-border">
        <h3 class="box-title">ព័ត៌មានគ្រួសារ</h3>
        <div class="box-body">
          <div class="form-group col-ms-12 col-md-12 col-xs-12">
            <div class="col-md-4 col-ms-4">
          ...
          <div class="form-group col-ms-12 col-md-12 col-xs-12">
            ...
            <div class="col-md-4 col-ms-4">
              {!! Form::label('per_family_job_father', 'មុខរបរ(ឪពុកក្មេក)', ['class'=>'control-label']); !!}
              {!! Form::text('per_family_job_father', null, ['class'=>'form-control', 'placeholder'=>'មុខរបរ(ឪពុកក្មេក)']); !!}
              {!! $errors->has('per_family_job_father')?$errors->first('per_family_job_father'):'' !!}
            </div>
          </div>
          <div class="form-group col-ms-12 col-md-12 col-xs-12">
            <div class="col-md-4 col-ms-4">
            ...
            <div class="col-md-4 col-ms-4">
              {!! Form::label('per_family_job_mother', 'មុខរបរ(ម្ដាយក្មេក)', ['class'=>'control-label']); !!}
              {!! Form::text('per_family_job_mother', null, ['class'=>'form-control', 'placeholder'=>'មុខរបរ(ម្ដាយក្មេក)']); !!}
              {!! $errors->has('per_family_job_mother')?$errors->first('per_family_job_mother'):'' !!}
            </div>
          </div>
        </div>
      </div>      
        <!-- End_PersonFamily -->
              ...
              <!-- Knowlege -->
      <div class="box box-success box-header with-border">
        <h3 class="box-title">កម្រិតវប្បធម៌ទូទៅ និងកម្រិតជំនាញ</h3>
        <div class="box-body">
      ...
      <!-- End_Knowlege -->
          ...
          <!-- WorkingHistory -->
      <div class="box box-success box-header with-border">
        <h3 class="box-title">ប្រវត្តិការងារ</h3>
        <div class="box-body">
          <div class="form-group col-ms-12 col-md-12 col-xs-12 box box-warning">
            <div class="col-md-4 col-ms-4">
          ...
          <div class="form-group col-ms-12 col-md-12 col-xs-12 box box-warning">
            ...
            <!-- Medal -->
      <div class="box box-success box-header with-border">
        <h3 class="box-title">សកម្មភាពការងារ និងមុខដំណែងដែលបានទទួលកន្លងមក</h3>
        <div class="box-body">
          <div class="form-group col-ms-12 col-md-12 col-xs-12 box box-warning">
            <div class="col-md-6 col-ms-6">
              {!! Form::label('staff_medal_tittle1', 'ឋារន្តរស័ក្ដិ', ['class'=>'control-label']); !!}
              {!! Form::text('staff_medal_tittle1', null, ['class'=>'form-control', 'placeholder'=>'ឋារន្តរស័ក្ដិ']); !!}
              {!! $errors->has('staff_medal_tittle1')?$errors->first('staff_medal_tittle1'):'' !!}
            </div>
            <div class="col-md-6 col-ms-6">
              {!! Form::label('staff_medal_date1', 'កាលបរិច្ឆេទទទួលឋារន្តរស័ក្ដិ', ['class'=>'control-label']); !!}
              {!! Form::text('staff_medal_date1', null, ['class'=>'form-control', 'placeholder'=>'ថ្ងៃ-ខែ-ឆ្នាំ']); !!}
              {!! $errors->has('staff_medal_date1')?$errors->first('staff_medal_date1'):'' !!}
            </div>
          </div>
          <div class="form-group col-ms-12 col-md-12 col-xs-12 box box-warning">
            <div class="col-md-6 col-ms-6">
              {!! Form::label('staff_medal_tittle2', 'ឋារន្តរស័ក្ដិ', ['class'=>'control-label']); !!}
              {!! Form::text('staff_medal_tittle2', null, ['class'=>'form-control', 'placeholder'=>'ឋារន្តរស័ក្ដិ']); !!}
              {!! $errors->has('staff_medal_tittle2')?$errors->first('staff_medal_tittle2'):'' !!}
            </div>
            <div class="col-md-6 col-ms-6">
              {!! Form::label('staff_medal_date2', 'កាលបរិច្ឆេទទទួលឋារន្តរស័ក្ដិ', ['class'=>'control-label']); !!}
              {!! Form::text('staff_medal_date2', null, ['class'=>'form-control', 'placeholder'=>'ថ្ងៃ-ខែ-ឆ្នាំ']); !!}
              {!! $errors->has('staff_medal_date2')?$errors->first('staff_medal_date2'):'' !!}
            </div>
          </div>
          <div class="form-group col-ms-12 col-md-12 col-xs-12 box box-warning">
            <div class="col-md-6 col-ms-6">
              {!! Form::label('staff_medal_tittle3', 'ឋារន្តរស័ក្ដិ', ['class'=>'control-label']); !!}
              {!! Form::text('staff_medal_tittle3', null, ['class'=>'form-control', 'placeholder'=>'ឋារន្តរស័ក្ដិ']); !!}
              {!! $errors->has('staff_medal_tittle3')?$errors->first('staff_medal_tittle'):'' !!}
            </div>
            <div class="col-md-6 col-ms-6">
              {!! Form::label('staff_medal_date3', 'កាលបរិច្ឆេទទទួលឋារន្តរស័ក្ដិ', ['class'=>'control-label']); !!}
              {!! Form::text('staff_medal_date3', null, ['class'=>'form-control', 'placeholder'=>'ថ្ងៃ-ខែ-ឆ្នាំ']); !!}
              {!! $errors->has('staff_medal_date3')?$errors->first('staff_medal_date3'):'' !!}
            </div>
          </div>
        </div>
      </div>
            ...
            <!-- SubSkill -->
      <div class="box box-success box-header with-border">
        <h3 class="box-title">កម្រិតបណ្ដុះបណ្ដាលវិជ្ជាជីវៈ (ជំនាញបច្ចេកទេស-ឯកទេស)</h3>
        <div class="box-body">
          <div class="form-group col-ms-12 col-md-12 col-xs-12 box box-warning">
            <div class="col-md-6 col-ms-6">
              {!! Form::label('per_sub_skill_name1', 'ឈ្មោះ', ['class'=>'control-label']); !!}
              {!! Form::text('per_sub_skill_name1', null, ['class'=>'form-control', 'placeholder'=>'ឈ្មោះ']); !!}
              {!! $errors->has('per_sub_skill_name1')?$errors->first('per_sub_skill_name1'):'' !!}
            </div>
            <div class="col-md-6 col-ms-6">
              {!! Form::label('per_sub_skill_date1', 'កាលបរិច្ឆេទទទួល', ['class'=>'control-label']); !!}
              {!! Form::text('per_sub_skill_date1', null, ['class'=>'form-control', 'placeholder'=>'ថ្ងៃ-ខែ-ឆ្នាំ']); !!}
              {!! $errors->has('per_sub_skill_date1')?$errors->first('per_sub_skill_date1'):'' !!}
            </div>
          </div>
          <div class="form-group col-ms-12 col-md-12 col-xs-12 box box-warning">
            <div class="col-md-6 col-ms-6">
              {!! Form::label('per_sub_skill_name2', 'ឈ្មោះ', ['class'=>'control-label']); !!}
              {!! Form::text('per_sub_skill_name2', null, ['class'=>'form-control', 'placeholder'=>'ឈ្មោះ']); !!}
              {!! $errors->has('per_sub_skill_name2')?$errors->first('per_sub_skill_name2'):'' !!}
            </div>
            <div class="col-md-6 col-ms-6">
              {!! Form::label('per_sub_skill_date2', 'កាលបរិច្ឆេទទទួល', ['class'=>'control-label']); !!}
              {!! Form::text('per_sub_skill_date2', null, ['class'=>'form-control', 'placeholder'=>'ថ្ងៃ-ខែ-ឆ្នាំ']); !!}
              {!! $errors->has('per_sub_skill_date2')?$errors->first('per_sub_skill_date2'):'' !!}
            </div>
          </div>
          <div class="form-group col-ms-12 col-md-12 col-xs-12 box box-warning">
            <div class="col-md-6 col-ms-6">
              {!! Form::label('per_sub_skill_name3', 'ឈ្មោះ', ['class'=>'control-label']); !!}
              {!! Form::text('per_sub_skill_name3', null, ['class'=>'form-control', 'placeholder'=>'ឈ្មោះ']); !!}
              {!! $errors->has('per_sub_skill_name3')?$errors->first('per_sub_skill_name3'):'' !!}
            </div>
            <div class="col-md-6 col-ms-6">
              {!! Form::label('per_sub_skill_date3', 'កាលបរិច្ឆេទទទួល', ['class'=>'control-label']); !!}
              {!! Form::text('per_sub_skill_date3', null, ['class'=>'form-control', 'placeholder'=>'ថ្ងៃ-ខែ-ឆ្នាំ']); !!}
              {!! $errors->has('per_sub_skill_date3')?$errors->first('per_sub_skill_date3'):'' !!}
            </div>
          </div>
        </div>
      </div>
            <!-- End_SubSkill -->
             ...
             <!-- Warning -->
      <div class="box box-success box-header with-border">
        <h3 class="box-title">ការទទួលពិន័យ ឬព្រមាន</h3>
        <div class="box-body">
          <div class="form-group col-ms-12 col-md-12 col-xs-12 box box-warning">
            <div class="col-md-12 col-ms-12">
              {!! Form::label('staff_warning_desc', 'បរិយាយ', ['class'=>'control-label']); !!}
              {!! Form::text('staff_warning_desc', null, ['class'=>'form-control', 'placeholder'=>'បរិយាយ']); !!}
