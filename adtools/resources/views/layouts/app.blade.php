...
<body class="hold-transition skin-blue sidebar-mini" style="font-family: Khmer OS Siemreap; font-size: 11pt;">
<div class="wrapper">
  ...
  <header class="main-header">
    ...
    <a href="index2.html" class="logo">
      ...
      <span class="logo-mini"><b>គលព</b></span>
    ...
    <nav class="navbar navbar-static-top">
      ...
      <div class="navbar-custom-menu">
        <ul class="nav navbar-nav">
            ...
            @if (Auth::guest())
                <li><a href="{{ route('login') }}">ចូលកម្មវិធី</a></li>
            @else
                ...
                <li class="dropdown user user-menu">
                    ...
                    <!-- User image -->
                        ...
                        <li class="user-footer">
                            ...
                            <a href="change_password" class="btn btn-default btn-flat" >ប្ដូរលេខសម្ងាត់</a>
                            <a href="{{ route('logout') }}" class="btn btn-default btn-flat" onclick="event.preventDefault(); document.getElementById('logout-form').submit();">ចាកចេញ</a>
                            </div>
