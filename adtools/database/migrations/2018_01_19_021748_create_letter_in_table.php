...
class CreateLetterInTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('letter_in', function (Blueprint $table) {
            ...
            $table->string('letter_source', 150)->nullable()->collation('utf8_unicode_ci');
            $table->string('letter_target', 150)->nullable()->collation('utf8_unicode_ci');
